...
function cleanup_tempest_leftovers() {
  ...
  for project in $(openstack project list --domain tempest | grep -E 'tempest-*' | awk '{ print $2 }'); do openstack project delete ${project}; done
  ...
  for user in $(openstack user list --domain tempest | grep -E 'tempest-*' | awk '{ print $2 }'); do openstack user delete ${user}; done
